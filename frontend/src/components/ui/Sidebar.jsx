        ...
        {devOpen && (
          <div onClick={() => setDevOpen(false)} style={{
            ...
            <div onClick={e => e.stopPropagation()} style={{
              ...
              borderRadius: 24, padding: 48, width: 560, maxWidth: '95vw',
              ...
              <p style={{ fontSize: 11, color: '#667eea', margin: '0 0 4px',
              ...
              <div style={{ background: 'rgba(255,255,255,0.05)', borderRadius: 14,
                ...
                <a href="tel:+917079064312" style={{
                  color: '#a0aec0', textDecoration: 'none', display: 'flex',
                  alignItems: 'center', gap: 10, marginBottom: 12, fontSize: 14
                }}>
                  <i className="bi bi-telephone-fill" style={{ color: '#667eea', fontSize: 16 }} />
                  +91 7079064312
                </a>
                <a href="mailto:uditkumar969364@gmail.com" style={{
                  color: '#a0aec0', textDecoration: 'none', display: 'flex',
              ...
              <div style={{ display: 'flex', justifyContent: 'center', gap: 12 }}>
                <a href="https://instagram.com/udit.chandrvnshi" target="_blank" rel="noreferrer" style={{
                ...
                <a href="https://linkedin.com/in/udit-kumar-01b3b5288" target="_blank" rel="noreferrer" style={{
                  background: '#0077b5',
                  borderRadius: 12, padding: '10px 16px', color: 'white',
                  textDecoration: 'none', fontSize: 13, fontWeight: 600,
                  display: 'flex', alignItems: 'center', gap: 6
                ...
                <a href="https://github.com/Uditkumc" target="_blank" rel="noreferrer" style={{
                  background: '#333',
                  borderRadius: 12, padding: '10px 16px', color: 'white',
                  textDecoration: 'none', fontSize: 13, fontWeight: 600,
                  display: 'flex', alignItems: 'center', gap: 6
